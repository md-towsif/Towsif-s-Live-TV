...
export default function Ticker() {
  const repeatedText = [...TICKER_MESSAGES, ...TICKER_MESSAGES, ...TICKER_MESSAGES].join("   •   ");
  ...
  return (
    <div className="fixed top-[64px] left-0 right-0 h-[36px] bg-[#0d1221] border-b border-[#1c2d45] flex items-center overflow-hidden z-30 select-none">
      <div className="relative w-full flex items-center">
        ...
        <div 
          className="whitespace-nowrap flex text-[0.76rem] text-slate-400 font-medium py-1 animate-[marquee_45s_linear_infinite] hover:[animation-play-state:paused]"
